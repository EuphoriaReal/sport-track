...
<div class="p-5 bg-primary text-white text-center" style="background-color: #7dc146 !important;"><!-- div texte blanc centré fond vert -->
  ...
  <div class="container mt-5" >
    ...
    <form action="/UploadActivityController" method="post" enctype="multipart/form-data"> <!-- questionnaire get qui redirige vers error.php , toutes les entrée sont obligatoires-->
      <div class="mb-3" style="margin-left: -8%; margin-right: -8%;"><!-- div responsive géré par Bootstrap -->
        ...
        <input required type="file" id="filejson" name="fichier" accept=".json" class="custom-file-input">
      </div>
      <img src="../image/dnd_arrow.gif" alt="fleche"/><!-- petite fleche animé -->
        <div>
